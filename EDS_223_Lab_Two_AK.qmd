...
## a) Simple Features from Scratch
...
if(st_crs(london_sf_transform) != st_crs(london_proj)){
  ...
  dataset2 <- st_transform(london_sf_transform, crs = st_crs(london_proj))
}
```

## b) Changing Map Projections
...
## a) Changing Commands with Pipes
...
## b) Vector Attribute Aggregation
